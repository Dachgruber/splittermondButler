...
public interface TickBar {
	...
	/**
	 * deletes a player from the TickBar. 
	 * Attention! There is no recycling bin!
	 * @param the user Object
	 */
	void killPlayer(User user);
	
	/**
	 * deletes an enemy from the TickBar. 
	 * Attention! There is no recycling bin!
	 * @param name the unique name
	 */
	...
	/**
	 * get the Turns at the current Tick.
	 * Wrapper of getTurnsAtPos() for the currentTick for convienience
	 */
